  ...
  loadRelationships(database) {
    return __async(this, null, function* () {
      this.relationships.forEach((relationship, name) => {
        const dataList = database.read((data) => data.name === name);
...
var ComponentFactory = class extends AbstractFactory {
  create(componentType, data, title = void 0, additionalInformation = void 0) {
    return __async(this, null, function* () {
      const component = new componentType(this.app);
...
// src/data/Session.ts
var Session = class extends AbstractOutlineRecord {
  constructor() {
    super(...arguments);
...
// src/data/Scene.ts
var Scene = class extends AbstractOutlineRecord {
  constructor() {
    super(...arguments);
...
// src/data/Faction.ts
var Faction = class extends AbstractElementRecord {
};
...
var Timeline = class extends AbstractElementRecord {
};

// src/data/Note.ts
var Note = class extends AbstractOutlineRecord {
  loadHierarchy(database) {
    return __async(this, null, function* () {
...
var CampaignModal = class extends AbstractModalComponent {
  constructor(app2, modal) {
    super(app2, modal);
    this.campaigns = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(1 /* Campaign */);
  }
...
var AdventureModal = class extends AbstractModalComponent {
  constructor(app2, modal) {
    super(app2, modal);
    this.adventures = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(2 /* Adventure */, this.modal.campaignId);
  }
  addElement(contentEl) {
    return __async(this, null, function* () {
...
var SessionModal = class extends AbstractModalComponent {
  constructor(app2, modal) {
    super(app2, modal);
    this.sessions = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(4 /* Session */, this.modal.campaignId, this.modal.adventureId);
  }
  addElement(contentEl) {
    return __async(this, null, function* () {
...
var SceneModal = class extends AbstractModalComponent {
  constructor(app2, modal) {
    ...
    if (this.modal.adventureId != null && this.modal.sessionId != null) {
      this.scenes = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(8 /* Scene */, this.modal.campaignId, this.modal.adventureId, this.modal.sessionId);
    } else {
      this.scenes = [];
    }
  }
...
var ResponseData = class {
  ...
  addComponent(type, data, title = void 0, additionalInformation = void 0, position = void 0) {
    return __async(this, null, function* () {
      let relationships = [];
      let relationship;
      ...
      const element = yield this.app.plugins.getPlugin("rpg-manager").factories.components.create(type, relationship != null ? relationship : relationships, title, additionalInformation);
  ...
  generateData(relationships, title, additionalInformation) {
    return __async(this, null, function* () {
      ...
      relationships.forEach((relationship) => {
        var _a, _b;
        const session = relationship.component;
        if (session !== void 0) {
          response.addContent([
...
var AdventureModel = class extends AbstractModel {
  generateData() {
    return __async(this, null, function* () {
      yield this.response.addComponent(SessionTableComponent, this.io.readListParametrised(4 /* Session */, this.currentElement.campaign.campaignId, this.currentElement.adventureId).sort(function(leftData, rightData) {
      ...
      relationships.forEach((relationship) => {
        ...
        if (record !== void 0) {
          response.addContent([
            ...
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create((_a = record.age) == null ? void 0 : _a.toString(), 0 /* String */, true),
...
var AdventureTableComponent = class extends AbstractComponent {
  generateData(relationships, title, additionalInformation) {
    return __async(this, null, function* () {
      ...
      relationships.forEach((relationship) => {
        const adventure = relationship.component;
        if (adventure !== void 0) {
          response.addContent([
...
var CampaignModel = class extends AbstractModel {
  generateData() {
    return __async(this, null, function* () {
      yield this.response.addComponent(AdventureTableComponent, this.io.readListParametrised(2 /* Adventure */, this.currentElement.campaignId).sort(function(leftData, rightData) {
      ...
      yield this.response.addComponent(SessionTableComponent, this.io.readListParametrised(4 /* Session */, this.currentElement.campaignId).sort(function(leftData, rightData) {
        if (leftData.sessionId > rightData.sessionId)
          return -1;
        if (leftData.sessionId < rightData.sessionId)
          return 1;
      ...
      yield this.response.addComponent(CharacterTableComponent, this.io.readListParametrised(16 /* Character */ | 32 /* NonPlayerCharacter */, this.currentElement.campaignId).sort(function(leftData, rightData) {
...
var AbtPlotComponent = class extends AbstractComponent {
  generateData(relationship, title, additionalInformation) {
    return __async(this, null, function* () {
      ...
      const data = relationship.component;
      const response = new ResponseTable(this.app);
      if (data instanceof Adventure && this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(4 /* Session */, data.campaign.campaignId, data.adventureId).length === 0 && additionalInformation.need !== "" && additionalInformation.and !== "" && additionalInformation.but !== "" && additionalInformation.therefore !== "") {
  ...
  generateData() {
    return __async(this, null, function* () {
      ...
      if (((_a = this.sourceMeta) == null ? void 0 : _a.abt) != null) {
        yield this.response.addComponent(AbtPlotComponent, this.currentElement, void 0, this.sourceMeta.abt);
      }
      return this.response;
    });
  }
      ...
      relationships.forEach((relationship) => {
        ...
        if (record !== void 0) {
          response.addContent([
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create(record.imageSrcElement, 5 /* Image */, true),
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create(record.link, 2 /* Link */, true),
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create((_a = record.date) == null ? void 0 : _a.toDateString(), 0 /* String */),
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create(relationship.description !== "" ? relationship.description : record.synopsis, 4 /* Markdown */)
          ]);
        }
      });
...
var SceneTableComponent = class extends AbstractComponent {
  generateData(relationships, title, additionalInformation) {
    return __async(this, null, function* () {
      ...
      relationships.forEach((relationship) => {
        const scene = relationship.component;
        if (scene !== void 0) {
          response.addContent([
  ...
  generateData(relationships, title, additionalInformation) {
    return __async(this, null, function* () {
      ...
      for (let musicCounter = 0; musicCounter < relationships.length; musicCounter++) {
        const record = relationships[musicCounter].component;
        if (record !== void 0) {
          response.addContent([
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create(yield record.getDynamicImageSrcElement(), 5 /* Image */, true),
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create(record.link, 2 /* Link */, true),
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create((_a = record.url) != null ? _a : '<span class="rpgm-missing">No URL provided</span>', 4 /* Markdown */),
            this.app.plugins.getPlugin("rpg-manager").factories.contents.create(relationships[musicCounter].description !== "" ? relationships[musicCounter].description : record.synopsis, 4 /* Markdown */)
          ]);
        }
      }
      return response;
...
var SceneNavigationModel = class extends AbstractModel {
  generateData() {
    return __async(this, null, function* () {
      this.response.addElement(this.generateBreadcrumb());
      yield this.response.addComponent(HeaderComponent, this.currentElement, void 0, this.sourceMeta);
      return this.response;
    });
  }
};
  ...
  generateData() {
    return __async(this, null, function* () {
      ...
      if (((_b = this.sourceMeta) == null ? void 0 : _b.storycircle) != null) {
        yield this.response.addComponent(StoryCirclePlotComponent, this.currentElement, void 0, this.sourceMeta.storycircle);
      }
      return this.response;
    });
  }
...
var TimelineModel = class extends AbstractModel {
  generateData() {
    return __async(this, null, function* () {
      yield this.response.addComponent(BannerComponent, this.currentElement);
  ...
  addEvents(timeline) {
    const events = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(128 /* Event */, this.currentElement.campaign.campaignId);
  ...
  addClues(timeline) {
    const clues = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(256 /* Clue */, this.currentElement.campaign.campaignId);
  ...
  addBirths(timeline) {
    const characters = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(16 /* Character */ | 32 /* NonPlayerCharacter */, this.currentElement.campaign.campaignId);
  ...
  addSessions(timeline) {
    const sessions = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(4 /* Session */, this.currentElement.campaign.campaignId);
  ...
  addCharacterRecordSheet(response) {
    return __async(this, null, function* () {
      response.then((response2) => {
        response2.addComponent(RawCharacterRecordSheetComponent, this.currentElement, void 0, this.sourceMeta, 2);
      });
    });
  }
};
        ...
        case 2 /* Adventure */:
          ...
          createButtonEl.addEventListener("click", () => {
            if (data.campaignId !== void 0 && data.adventureId !== void 0) {
              const previousAdventure = this.app.plugins.getPlugin("rpg-manager").database.readSingleParametrised(2 /* Adventure */, data.campaignId, data.adventureId - 1);
              let nextSessionId = 1;
              if (previousAdventure != null) {
                const previousAdventureSessions = this.app.plugins.getPlugin("rpg-manager").database.readListParametrised(4 /* Session */, data.campaignId, previousAdventure.adventureId);
...
var RelationshipFactory = class {
  ...
  readRelationships(baseName, content, relationships, isInFrontMatter) {
      ...
      while (line.indexOf("[[") !== -1) {
        ...
        if (isInFrontMatter) {
          ...
          if (remainingFrontmatter[0] === ":") {
            ...
            if (relationshipDescription !== "" && relationshipDescription[0] === relationshipDescription[relationshipDescription.length - 1] && (relationshipDescription[0] === '"' || relationshipDescription[0] === "'")) {
...
var DatabaseInitialiser = class {
  static initialise(app2) {
    return __async(this, null, function* () {
      ...
      this.database = yield this.app.plugins.getPlugin("rpg-manager").factories.database.create();
      const temporaryDatabase = yield this.app.plugins.getPlugin("rpg-manager").factories.database.create();
      ...
      for (let index = 0; index < markdownFiles.length; index++) {
        try {
          ...
          if (data !== void 0) {
            if (data instanceof AbstractOutlineRecord)
  ...
  static buildHierarchyAndRelationships(temporaryDatabase) {
    return __async(this, null, function* () {
      ...
      return yield this.addHierarchy(temporaryDatabase, 1 /* Campaign */).then(() => {
...
DatabaseInitialiser.campaignSettings = /* @__PURE__ */ new Map();
...
var Database = class extends import_obsidian16.Component {
  ...
  readListParametrised(dataType, campaignId = void 0, adventureId = void 0, sessionId = void 0, sceneId = void 0, comparison = void 0) {
    return this.read(this.generateQuery(dataType, true, void 0, void 0, campaignId, adventureId, sessionId, sceneId), comparison);
  }
  readList(dataType, comparison = void 0, tag, overloadId = void 0) {
    return this.read(this.generateQuery(dataType, true, tag, overloadId), comparison);
  }
  onDelete(file) {
    return __async(this, null, function* () {
  ...
  onRename(file, oldPath) {
    return __async(this, null, function* () {
      ...
      const metadata = this.app.metadataCache.getFileCache(file);
      const data = this.readByPath(file.path);
...
var Id = class {
  constructor(app2, type, tag = void 0, tags = void 0) {
    ...
    if (tag === void 0 && tags === void 0)
      throw new Error("Tag and Tags are undefined");
    if (tag !== void 0) {
      this.tag = tag;
    ...
    if (this.tag === void 0)
      throw new Error("Impossible to find the tag");
    this.tagMap = /* @__PURE__ */ new Map();
    this.tagMap.set(1 /* Campaign */, { status: 2 /* Missing */, value: void 0 });
    this.tagMap.set(2 /* Adventure */, { status: 3 /* NotRequired */, value: void 0 });
    this.tagMap.set(4 /* Session */, { status: 3 /* NotRequired */, value: void 0 });
    this.tagMap.set(8 /* Scene */, { status: 3 /* NotRequired */, value: void 0 });
  }
...
var TagFactory = class {
  ...
  generateTag(type, campaignId, adventureId = void 0, sessionId = void 0, sceneId = void 0) {
    var _a;
    let response = "";
    switch (type) {
      case 8 /* Scene */:
    ...
    return ((_a = this.dataSettings.get(type)) != null ? _a : "") + response;
  }
  ...
  createId(tag = void 0, tags = void 0) {
    ...
    switch (dataType) {
      case 8 /* Scene */:
        response.addValue(8 /* Scene */, ids[3]);
      case 4 /* Session */:
      case 1024 /* Note */:
        response.addValue(4 /* Session */, ids[2]);
      case 2 /* Adventure */:
        response.addValue(2 /* Adventure */, ids[1]);
      default:
        response.addValue(1 /* Campaign */, idString !== "" ? ids[0] : void 0);
    }
    return response;
  }
  getTagIds(tag = void 0, tags = void 0) {
...
var RpgManagerSettings = class extends import_obsidian19.PluginSettingTab {
  constructor(app2) {
    ...
    this.map.set(0 /* PC */, { title: "Player Character Tag", value: this.plugin.settings.pcTag, placeholder: "rpgm/element/character/pc" });
    this.map.set(1 /* NPC */, { title: "Non Player Character Tag", value: this.plugin.settings.npcTag, placeholder: "rpgm/element/character/npc" });
    this.map.set(2 /* Location */, { title: "Location Tag", value: this.plugin.settings.locationTag, placeholder: "rpgm/element/location" });
    this.map.set(3 /* Faction */, { title: "Faction Tag", value: this.plugin.settings.factionTag, placeholder: "rpgm/element/faction" });
    this.map.set(4 /* Clue */, { title: "Clue Tag", value: this.plugin.settings.eventTag, placeholder: "rpgm/element/event" });
    this.map.set(5 /* Event */, { title: "Event Tag", value: this.plugin.settings.clueTag, placeholder: "rpgm/element/clue" });
    this.map.set(7 /* Timeline */, { title: "Timeline Tag", value: this.plugin.settings.timelineTag, placeholder: "rpgm/element/timeline" });
    this.map.set(8 /* Note */, { title: "Note Tag", value: this.plugin.settings.noteTag, placeholder: "rpgm/element/note" });
    this.map.set(6 /* Music */, { title: "Music Tag", value: this.plugin.settings.musicTag, placeholder: "rpgm/element/music" });
    this.map.set(9 /* Campaign */, { title: "Campaign Outline Tag", value: this.plugin.settings.campaignTag, placeholder: "rpgm/outline/campaign" });
    this.map.set(10 /* Adventure */, { title: "Adventure Outline Tag", value: this.plugin.settings.adventureTag, placeholder: "rpgm/outline/adventure" });
    this.map.set(11 /* Session */, { title: "Session Outline Tag", value: this.plugin.settings.sessionTag, placeholder: "rpgm/outline/session" });
    this.map.set(12 /* Scene */, { title: "Scene Outline Tag", value: this.plugin.settings.sceneTag, placeholder: "rpgm/outline/scene" });
    this.map.set(14 /* YouTubeApiKey */, { title: "YouTube API Key", value: this.plugin.settings.YouTubeKey, placeholder: "Your YouTube API Key" });
    this.map.set(13 /* automaticMove */, { title: "Automatically organise elements in folders", value: this.plugin.settings.automaticMove, placeholder: "Organise new elements" });
    this.map.set(15 /* templateFolder */, { title: "Template folder", value: this.plugin.settings.templateFolder, placeholder: "Template Folder" });
  ...
  saveSettings() {
    return __async(this, null, function* () {
      ...
      const updatedTags = /* @__PURE__ */ new Map();
      let doUpdate = false;
      const settingsToUpdate = {};
      if (this.plugin.settings.campaignTag !== ((_a = this.map.get(9 /* Campaign */)) == null ? void 0 : _a.value)) {
        settingsToUpdate.campaignTag = (_b = this.map.get(9 /* Campaign */)) == null ? void 0 : _b.value;
        updatedTags.set(this.plugin.settings.campaignTag, (_c = this.map.get(9 /* Campaign */)) == null ? void 0 : _c.value);
      }
      if (this.plugin.settings.adventureTag !== ((_d = this.map.get(10 /* Adventure */)) == null ? void 0 : _d.value)) {
        settingsToUpdate.adventureTag = (_e = this.map.get(10 /* Adventure */)) == null ? void 0 : _e.value;
        updatedTags.set(this.plugin.settings.adventureTag, (_f = this.map.get(10 /* Adventure */)) == null ? void 0 : _f.value);
        doUpdate = true;
      }
      if (this.plugin.settings.sessionTag !== ((_g = this.map.get(11 /* Session */)) == null ? void 0 : _g.value)) {
        settingsToUpdate.sessionTag = (_h = this.map.get(11 /* Session */)) == null ? void 0 : _h.value;
        updatedTags.set(this.plugin.settings.sessionTag, (_i = this.map.get(11 /* Session */)) == null ? void 0 : _i.value);
        doUpdate = true;
      }
      if (this.plugin.settings.sceneTag !== ((_j = this.map.get(12 /* Scene */)) == null ? void 0 : _j.value)) {
        settingsToUpdate.sceneTag = (_k = this.map.get(12 /* Scene */)) == null ? void 0 : _k.value;
        updatedTags.set(this.plugin.settings.sceneTag, (_l = this.map.get(12 /* Scene */)) == null ? void 0 : _l.value);
        doUpdate = true;
      }
      if (this.plugin.settings.noteTag !== ((_m = this.map.get(8 /* Note */)) == null ? void 0 : _m.value)) {
        settingsToUpdate.noteTag = (_n = this.map.get(8 /* Note */)) == null ? void 0 : _n.value;
        updatedTags.set(this.plugin.settings.noteTag, (_o = this.map.get(8 /* Note */)) == null ? void 0 : _o.value);
        doUpdate = true;
      }
      if (this.plugin.settings.pcTag !== ((_p = this.map.get(0 /* PC */)) == null ? void 0 : _p.value)) {
        settingsToUpdate.pcTag = (_q = this.map.get(0 /* PC */)) == null ? void 0 : _q.value;
        updatedTags.set(this.plugin.settings.pcTag, (_r = this.map.get(0 /* PC */)) == null ? void 0 : _r.value);
        doUpdate = true;
      }
      if (this.plugin.settings.npcTag !== ((_s = this.map.get(1 /* NPC */)) == null ? void 0 : _s.value)) {
        settingsToUpdate.npcTag = (_t = this.map.get(1 /* NPC */)) == null ? void 0 : _t.value;
        updatedTags.set(this.plugin.settings.npcTag, (_u = this.map.get(1 /* NPC */)) == null ? void 0 : _u.value);
        doUpdate = true;
      }
      if (this.plugin.settings.factionTag !== ((_v = this.map.get(3 /* Faction */)) == null ? void 0 : _v.value)) {
        settingsToUpdate.factionTag = (_w = this.map.get(3 /* Faction */)) == null ? void 0 : _w.value;
        updatedTags.set(this.plugin.settings.factionTag, (_x = this.map.get(3 /* Faction */)) == null ? void 0 : _x.value);
        doUpdate = true;
      }
      if (this.plugin.settings.locationTag !== ((_y = this.map.get(2 /* Location */)) == null ? void 0 : _y.value)) {
        settingsToUpdate.locationTag = (_z = this.map.get(2 /* Location */)) == null ? void 0 : _z.value;
        updatedTags.set(this.plugin.settings.locationTag, (_A = this.map.get(2 /* Location */)) == null ? void 0 : _A.value);
        doUpdate = true;
      }
      if (this.plugin.settings.eventTag !== ((_B = this.map.get(5 /* Event */)) == null ? void 0 : _B.value)) {
        settingsToUpdate.eventTag = (_C = this.map.get(5 /* Event */)) == null ? void 0 : _C.value;
        updatedTags.set(this.plugin.settings.eventTag, (_D = this.map.get(5 /* Event */)) == null ? void 0 : _D.value);
        doUpdate = true;
      }
      if (this.plugin.settings.clueTag !== ((_E = this.map.get(4 /* Clue */)) == null ? void 0 : _E.value)) {
        settingsToUpdate.clueTag = (_F = this.map.get(4 /* Clue */)) == null ? void 0 : _F.value;
        updatedTags.set(this.plugin.settings.clueTag, (_G = this.map.get(4 /* Clue */)) == null ? void 0 : _G.value);
        doUpdate = true;
      }
      if (this.plugin.settings.musicTag !== ((_H = this.map.get(6 /* Music */)) == null ? void 0 : _H.value)) {
        settingsToUpdate.musicTag = (_I = this.map.get(6 /* Music */)) == null ? void 0 : _I.value;
        updatedTags.set(this.plugin.settings.musicTag, (_J = this.map.get(6 /* Music */)) == null ? void 0 : _J.value);
        doUpdate = true;
      }
      if (this.plugin.settings.timelineTag !== ((_K = this.map.get(7 /* Timeline */)) == null ? void 0 : _K.value)) {
        settingsToUpdate.timelineTag = (_L = this.map.get(7 /* Timeline */)) == null ? void 0 : _L.value;
        updatedTags.set(this.plugin.settings.timelineTag, (_M = this.map.get(7 /* Timeline */)) == null ? void 0 : _M.value);
        doUpdate = true;
      }
      if (doUpdate) {
        yield this.plugin.updateSettings(settingsToUpdate);
        yield this.settingsUpdater.updateTags(updatedTags);
  ...
  loadElementSettings() {
    ...
    this.settingsFactory.createTextSetting(0 /* PC */, "This tag identifies the Player Characters");
    this.settingsFactory.createTextSetting(1 /* NPC */, "This tag identifies the Non Player Characters");
    this.settingsFactory.createTextSetting(2 /* Location */, "This tag identifies the Locations");
    this.settingsFactory.createTextSetting(3 /* Faction */, "This tag identifies the Factions");
    this.settingsFactory.createTextSetting(5 /* Event */, "This tag identifies the Events");
    this.settingsFactory.createTextSetting(4 /* Clue */, "This tag identifies the Clues");
    this.settingsFactory.createTextSetting(7 /* Timeline */, "This tag identifies the Timelines");
    this.settingsFactory.createTextSetting(6 /* Music */, "This tag identifies the Musics");
  }
  loadOutlineSettings() {
    this.settingsFactory.createHeader("Outlines", 3, `Outlines are the plot part of RPG Manager.
    ...
    this.settingsFactory.createWarning(`Warning: These settings will be saved only after pressing the button below
		All the tags will be updates in your notes.`);
    this.settingsFactory.createTextSetting(9 /* Campaign */, `The tag identifying the campaigns
			Required ids: /{campaignId}`);
    this.settingsFactory.createTextSetting(10 /* Adventure */, `The tag identifying the adventures
			Required ids: /{campaignId}/{adventureId}`);
    this.settingsFactory.createTextSetting(11 /* Session */, `The tag identifying the sessions
			Required ids: /{campaignId}/{adventureId}/{sessionId}`);
    this.settingsFactory.createTextSetting(12 /* Scene */, `The tag identifying the scenes
			Required ids: /{campaignId}/{adventureId}/{sessionId}/{sceneId}`);
    this.settingsFactory.createTextSetting(8 /* Note */, `The tag identifying the notes
			Required ids: /{campaignId}/{adventureId}/{sessionId}`);
  }
  loadExternalServicesSettings() {
    ...
    this.settingsFactory.createTextSetting(14 /* YouTubeApiKey */, `If you want to use the automation included in the Music element through YouTube, please generate a YouTube Api Key and add it here. 
  ...
  loadAutomationSettings() {
    ...
    this.settingsFactory.createToggleSetting(13 /* automaticMove */, `RPG Manager automatically organise created or filled outlines and elements in separate folders.
  ...
  loadTemplatesSettings() {
    ...
    this.settingsFactory.createDropdownSetting(15 /* templateFolder */, `Select the folder in which you keep the templates for RPG Manager.
			If you leave this value empty, the creation of outlines and elements won't have any additional information apart from the frontmatter and the codeblocks`, this.templateFolderMap);
  }
