...
export class NoteTemplate extends AbstractTemplate implements TemplateInterface {
	public getContent(): string {
		const characters = this.app.plugins.getPlugin('rpg-manager').database.readListParametrised<CharacterInterface>(undefined, DataType.Character | DataType.NonPlayerCharacter, this.campaignId);
