...
export class TagService extends AbstractService implements TagServiceInterface, ServiceInterface{
	...
	constructor(
		...
		this.dataSettings.set(ComponentType.Act, TagService.actTag);
		this.dataSettings.set(ComponentType.Scene, TagService.sceneTag);
		this.dataSettings.set(ComponentType.Session, TagService.sessionTag);
		this.dataSettings.set(ComponentType.Character, TagService.pcTag);
		this.dataSettings.set(ComponentType.Clue, TagService.clueTag);
		this.dataSettings.set(ComponentType.Event, TagService.eventTag);
		this.dataSettings.set(ComponentType.Faction, TagService.factionTag);
		this.dataSettings.set(ComponentType.Location, TagService.locationTag);
		this.dataSettings.set(ComponentType.NonPlayerCharacter, TagService.npcTag);
		this.dataSettings.set(ComponentType.Music, TagService.musicTag);
		this.dataSettings.set(ComponentType.Subplot, TagService.subplotTag);
