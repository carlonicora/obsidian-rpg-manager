...
export class ImageService {
	static createImage(app: App, api: RpgManagerInterface, imageData: any): ImageInterface | undefined {
	...
	private static _getImageLocation(app: App, api: RpgManagerInterface, path: string): string | undefined {
