...
import {Factories} from "../REFACTOR/factories/Factories";
...
import {DatabaseUpdater} from "../REFACTOR/services/updaters/DatabaseUpdater";
...
import {Manipulators} from "../REFACTOR/services/manipulators/Manipulators";
...
import {UpdaterModal} from "../REFACTOR/services/updaters/modals/UpdaterModal";
...
import {SearchService} from "../REFACTOR/services/searchService/SearchService";
...
export default class RpgManager extends Plugin implements RpgManagerInterface{
	...
	async onload() {
		...
		this.tagHelper = await new TagService(this.settings);
