...
export default class RpgManager extends Plugin implements RpgManagerInterface{
	...
	async onload() {
		...
		await addIcon("filled-star", '<g transform="scale(4.8)"><polygon id="svg_1" points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></g>');
		await addIcon("empty-star", '<g transform="translate(8, 10) scale(4)" fill="none" stroke="currentColor" stroke-width="2"><polygon id="svg_1" points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></g>');
