...
import { RpgManagerSettings } from "./interfaces/RpgManagerSettings";

export type PartialSettings = Partial<RpgManagerSettings>;

export const rpgManagerDefaultSettings: RpgManagerSettings = {
...
export class RpgManagerSettingsTab extends PluginSettingTab {
	private _folderMap: Map<string, string>;

	constructor(private _app: App, private _plugin: RpgManagerPlugin) {
		super(_app, _plugin);
