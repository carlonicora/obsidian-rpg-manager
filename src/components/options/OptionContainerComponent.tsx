...
export default function OptionContainerComponent({
  ...
  return (
    <div className="flex flex-col min-h-screen pb-16">
      ...
      <div className="rounded-md border border-[--background-modifier-border] bg-[--background-primary] p-3 col-span-1 text-xs">
        <div
          className="cursor-pointer text-[--text-accent] hover:text-[--text-accent-hover] pl-2 pr-2 pt-1 pb-1 border border-transparent hover:bg-[--background-primary-alt] hover:border-[--background-modifier-border] rounded-md"
          onClick={showReadme}
        >
          {t("documentation")}
        </div>
