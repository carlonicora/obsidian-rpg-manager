...
export default function NonPlayerCharacterWizardTypeStepComponent({
  ...
  const [characterType, setCharacterType] =
    React.useState<NonPlayerCharacterType>(wizardData.nonplayercharactertype);
  ...
  const types = [
    {
      ...
      description: t("npctype.description", {
        context: NonPlayerCharacterType.Main,
      }),
      selected: characterType === NonPlayerCharacterType.Main,
    },
    {
      type: NonPlayerCharacterType.Supporting,
      name: t("npctype.npctype", {
        context: NonPlayerCharacterType.Supporting,
      }),
      description: t("npctype.description", {
        context: NonPlayerCharacterType.Supporting,
      }),
    ...
    },
    {
      ...
      description: t("npctype.description", {
        context: NonPlayerCharacterType.Extra,
      }),
  ...
  return (
    <>
      <h3 className="!text-xl !font-extralight">
        {t("attributes.nonplayercharactertype")}
      </h3>
      <div className="!mt-3 !mb-3">
        <MarkdownComponent
          value={t("wizards.npc.description", { context: "type", name: name })}
        />
      </div>
      <div className="">
