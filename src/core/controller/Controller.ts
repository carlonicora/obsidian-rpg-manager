...
import {ModelInterface} from "../../REFACTOR/models/interfaces/ModelInterface";
...
export class Controller extends AbstractRpgManagerMarkdownRenderChild {
	...
	private async _render(
		...
		if (this._currentComponent === undefined){
			const rpgmComponent: ComponentModelInterface|undefined = this.app.plugins.getPlugin('rpg-manager').database.readByPath<ComponentModelInterface>(this._sourcePath);
