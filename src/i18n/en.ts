...
What's *{{name}}* stake?`,
  ...
  kishotenketsu: {
    ...
    description_ketsu:
      "**Conclusion**: also called ochi (落ち) or ending, wraps up the story.",
  },
  storycircle: {
    you: "You/They",
    need: "Need",
