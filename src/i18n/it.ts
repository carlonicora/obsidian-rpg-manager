export const i18nIt = {
	...
	arc: {
		...
		description_4:
			"Il personaggio inizia **conoscendo la verità**, ma poi la rifiuta, **abbracciando una bugia**.",
		description_5:
	...
	create: {
		...
		in_monster: "Aggiungi un nuovo Mostro alla nota corrente",		add_session: "Aggiungi una nuova Sessione",
